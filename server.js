    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .messages-container { flex: 1; padding: 20px; overflow-y: auto; display: flex; flex-direction: column; gap: 10px; background-image: url('githubusercontent.com'); background-opacity: 0.06; }
        ...
        .dot { inline-block; width: 8px; height: 8px; border-radius: 50%; display: inline-block; margin-right: 5px; }
    ...
    <body>
      ...
      <div id="chat-screen">
        <div class="app-container">
          ...
          <div class="sidebar">
            ...
            <div class="online-status-bar" id="user-list">Online spelers laden...</div>
            <div class="group-list" id="rooms-list">
              <!-- Groepen komen hier te staan -->
            </div>
          </div>
      ...
      <script>
        ...
        function selectRoom(roomName) {
          ...
          // Vraag oude chatgeschiedenis op
        ...
        function updateRoomsSidebar() {
          ...
          joinedRooms.forEach(room => {
            html += \`<div class="group-item" data-name="\${room}" onclick="selectRoom('\${room}')">
              <b># \${room}</b>
              <span style="font-size:11px; color:#8696a0;">actief</span>
            </div>\`;
          });
